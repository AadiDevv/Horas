...
export default function HeuresChart({ equipes }: HeuresChartProps) {
  ...
  // Trouver l'objectif commun (si tous ont le même)
    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-bold" style={{ color: '#333333' }}>Heures / Semaine</h3>
        </div>
      </div>
        ...
        <ResponsiveContainer width="100%" height={250}>
          ...
          >
            ...
            <YAxis
              ...
              domain={[0, 'dataMax + 5']}
              label={{ value: 'Heures', angle: -90, position: 'insideLeft', style: { fill: '#999999', fontSize: 12 } }}
            />
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#333333' }} />
