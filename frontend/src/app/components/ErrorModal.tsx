...
/**
 * Modal d'erreur pour les erreurs de logique métier (400, 403, 404, 409, 422)
 * Affiche un message clair et bloque l'interaction jusqu'à ce que l'utilisateur comprenne
 * Note: 403 = Permission refusée (l'utilisateur reste connecté)
 */
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        {/* Code d'erreur (optionnel, pour debug) */}
        {error.statusCode > 0 && (
        ...
        <div className="flex gap-3">
          {/* Bouton Réessayer (si l'erreur peut être retentée) */}
