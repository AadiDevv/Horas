...
export default function Testimonial() {
  return (
    <section className="flex justify-center items-center py-24 px-6 bg-white">
      <div className="bg-[#333333] text-white rounded-2xl p-12 max-w-4xl text-center shadow-lg">
